...
terumet = {}
terumet.version = {major=3, minor=3, patch=0, opw = 1}
...
local INTEROPS = {'3d_armor', 'technic', 'doors', 'unified_inventory', 'tubelib', 'dungeon_loot', 'moreores', 'farming', 'extra'}
...
--added documentation, copied from wiki by original author, license still applys(LGPL)

if core.get_modpath("doc") then
    terumet.do_lua_file('doc')
end