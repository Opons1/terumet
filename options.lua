...
terumet.options.ore_saw = {
    ...
    VALID_ORES = {
        ...
        ['birthstones:stone_with_alexandrite'] = 1,
        ['birthstones:stone_with_amethyst'] = 1,
        ['birthstones:stone_with_aquamarine'] = 1,
        ['birthstones:stone_with_diamond'] = 1,
        ['birthstones:stone_with_emerald'] = 1,
        ['birthstones:stone_with_garnet'] = 1,
        ['birthstones:stone_with_opal'] = 1,
        ['birthstones:stone_with_peridot'] = 1,
        ['birthstones:stone_with_ruby'] = 1,
        ['birthstones:stone_with_sapphire'] = 1,
        ['birthstones:stone_with_topaz'] = 1,
        ['birthstones:stone_with_zircon'] = 1,
        ['blox:glowore'] = 1,
        ['gs_amethyst:amethyst_ore'] = 1,
        ['gs_emerald:emerald_ore'] = 1,
        ['gs_ruby:ruby_ore'] = 1,
        ['gs_sapphire:sapphire_ore'] = 1,
        ['industrious:coal_with_diamond'] = 1,
        ['industrious:copper_block'] = 1,
        ['industrious:desert_stone_with_coal'] = 1,
        ['industrious:desert_stone_with_gold'] = 1,
        ['industrious:gold_block'] = 1,
        ['industrious:iron_block'] = 1,
        ['industrious:tin_block'] = 1,
        ['lapis:stone_with_lapis'] = 1,
        ["opw_events:stone_with_motillusion"] = 1,
        ['opw_events:stone_with_motillusion_dense'] = 1,
        ['techage:stone_with_baborium'] = 1,
    },
